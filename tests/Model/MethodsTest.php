...
{
    protected FactoryModel $factories;
    protected LawyerModel $lawyers;
    protected MachineModel $machines;
    protected ServicerModel $servicers;
    protected WorkerModel $workers;
    ...
    public function testReindex()
    {
        ...
        $this->assertSame([1, 3, 4], array_keys($factories));
    }
    ...
    public function testNotReindex()
    {
        ...
        $this->assertSame([0, 1, 2], array_keys($factories));
    }
    ...
    public function testWithImplicit()
    {
        ...
        $this->assertSame($lawyer, reset($servicer->lawyers));
    }
